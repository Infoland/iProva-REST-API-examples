...
Changed | **GET** search | Added parameter include_recommended_links ()
Removed | **GET** audits/findings/{finding_id}/attachments/{attachment_id}/download | Possible to download attachments of an audit finding
