...
| Change  | Route                                                                    | Remarks                                             |
| ------- | ------------------------------------------------------------------------ | --------------------------------------------------- |
| Added   | **GET** `/question_lists/cover_pages`                                    | Gets the available cover pages for question lists.  |
...
| Change  | Route                                                          | Remarks                                                              |
| ------- | -------------------------------------------------------------- | -------------------------------------------------------------------- |
| Changed | **GET** `/frameworks/items`                                    | Added new querystring parameters include_texts and include_comments. |
| Changed | **GET** `/frameworks/items/filter/{filter_id}`                 | Added new querystring parameters include_texts and include_comments. |
...
| Added     | **GET** `/documents/{document_id}/{state}/download`               | Download the contents of a binary document                                            |
...
| Removed   | **POST** `/hyperlink`                                             | This route is depricated, /hyperlinks is added as a replacement                       |
| Added     | **POST** `/hyperlinks`                                            | Creates hyperlinks                                                                    |
| Removed   | **GET** `/settings`                                               | This route is depricated                                                              |
| Removed   | **GET** `/settings/{name}`                                        | This route is depricated, route is split up in multiple sub-routes                    |
...
| Change | Route                                                | Remarks                                                                                                              |
| ------ | ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Change | **POST** `api/user_groups/{user_group_id}/members`   | Updated to enable adding multiple members in one call. _The user_id value is deprecated_ and replaced with user_ids. |
